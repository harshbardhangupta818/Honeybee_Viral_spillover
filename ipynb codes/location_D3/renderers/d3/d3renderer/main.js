...
exports.generateLinesLayer = function(branches, nodes, locations, branchAttributes) {
    ...
    global.g.append("defs").append("marker")
        .attr("id", "arrow")
    ...
    var lines = linesLayer.selectAll("path").data(branches).enter().append("path")
        ...
        .attr("d", function(d, i) {
            ...
            var sourceXY = global.projection([startX, startY]);
            var targetXY = global.projection([endX, endY]);
    ...
    global.g.selectAll(".arrowHead").remove();

    // Append arrow markers at midpoint of each curve
    lines.each(function(d) {
        ...
        global.g.append("path")
            .attr("d", "M" + midpoint.x + "," + midpoint.y + " L" + (midpoint.x - 5) + "," + (midpoint.y - 5) + " L" + (midpoint.x - 5) + "," + (midpoint.y + 5) + "Z")
            .attr("fill", "white")
            .attr("stroke", "none")
    ...
    linesLayer.selectAll(".line")
        ...
        .attr("stroke", function() {
            ...
            if (attributeValue == null) {
                ...
                color = "#000"; // Default color if attribute value is null
            }
            return color;
        });
}
