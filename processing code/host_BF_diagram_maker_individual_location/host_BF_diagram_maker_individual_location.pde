...
float cutoff = 2.0; // Transmission rate cutoff
float map_value = 3.0;
float textsize_BF = 30;
float textsize_host = 30;
String heading = "LSV Transmission Map";
String[] virus = {"Lake Sinai Virus"};
...
void setup() {
  ...
  String[] filenames = {
    "/Users/hbg/Documents/filtered_contigs/first_alignment_60/Beast_results_2/LSV/LSV_location_2.txt",
  };
...
void visualizeCombinedFlow() {
  if (hostLabels != null && transmissionRatesList.size() > 0) {
    ...
    float[] adjustX = {60,0,-80,0};
    float[] adjustY = {0,40,0,-40};
